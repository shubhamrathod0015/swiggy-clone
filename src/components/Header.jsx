    ...
    <div className="bg-[#ff5200] font-serif ">
      <div className="flex justify-between  container mx-auto py-8">
        ...
        <div className="text-white text-base font-bold flex items-center  gap-15">
          <a target="_black" href="https://www.swiggy.com/corporate/">
            Swiggy Corporate
          </a>
          <a target="_black" href="https://partner.swiggy.com/login#/swiggy">
            Partner with Us
          </a>
          <a
      ...
      <div className="pt-16 pb-8 relative">
        ...
        ></img>
        <div className="max-w-[60%] text-white text-5xl font-bold container mx-auto text-center ">
